...
router.post('/new', petValidators, requireAuth, csrfProtection, asyncHandler(async (req, res) => {
...
router.post('/:id(\\d+)/edit', requireAuth, petValidators, csrfProtection, asyncHandler(async (req, res) => {
    const id = parseInt(req.params.id);
...
// router.get('/pets/:id(\\d+)/delete', requireAuth, csrfProtection, asyncHandler(async(req, res) => {
//         const id = parseInt(req.params.id);
//         const pet =  await db.Pet.findByPk(id)
